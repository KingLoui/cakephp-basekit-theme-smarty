...
<?php $this->append('css'); ?>
    <?= $this->Html->css('KingLoui/BaseKitThemeTwentySixteen./plugins/iCheck/custom.css') ?>
<?php $this->end(); ?>
<?php // Body scripts
    $this->Html->script(
    [
        'KingLoui/BaseKitThemeTwentySixteen./plugins/jqueryui/jquery-ui.min.js', 
        'KingLoui/BaseKitThemeTwentySixteen./plugins/iCheck/icheck.min.js', 
        'KingLoui/BaseKitThemeTwentySixteen./plugins/jvectormap/jquery-jvectormap-2.0.3.min.js', 
        'KingLoui/BaseKitThemeTwentySixteen./plugins/jvectormap/jquery-jvectormap-world-mill-en.js', 
        'KingLoui/BaseKitThemeTwentySixteen./plugins/flot/jquery.flot.js', 
        'KingLoui/BaseKitThemeTwentySixteen./plugins/flot/jquery.flot.tooltip.min.js', 
        'KingLoui/BaseKitThemeTwentySixteen./plugins/flot/jquery.flot.resize.js', 
    ], 
    ...
    <div class="row">
        <div class="col-lg-4">
                <div class="widget-head-color-box navy-bg p-lg text-center">
                    ...
                    <?= $this->Html->image('KingLoui/BaseKitThemeTwentySixteen.theme-basekit-admin/themeexamples/a4.jpg', 
        ...
        <div class="chat-activity-list">
            ...
            <div class="chat-element">
                <a href="#" class="pull-left">
                    <?= $this->Html->image('KingLoui/BaseKitThemeTwentySixteen.theme-basekit-admin/themeexamples/a2.jpg', 
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="ibox-content text-center">
                        <h1>Nicki Smith</h1>
                        <div class="m-b-sm">
                            <?= $this->Html->image('KingLoui/BaseKitThemeTwentySixteen.theme-basekit-admin/themeexamples/a8.jpg', 
                    ['class' => 'img-circle', 'alt' => 'image']) ?>
